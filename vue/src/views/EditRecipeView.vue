        ...
        <div class="card bg-light mb-3">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="recipeName" v-model="editedRecipe.name" placeholder="Recipe Name...">
            </div>
            <div class="form-group">
              <label for="ingredients">Ingredients</label>
              <textarea class="form-control" id="ingredients" rows="3" v-model="editedRecipe.ingredients" placeholder="Add a comma after each ingredient..."></textarea>
            </div>
            <div class="form-group">
              <label for="instructions">Instructions</label>
              <textarea class="form-control" id="instructions" rows="3" v-model="editedRecipe.instructions" placeholder="Add a period after each sentence..."></textarea>
            </div>
            <div class="form-group">
              <label for="recipeImage">Recipe Image</label>
              <input type="text" class="form-control" id="recipeImage" v-model="editedRecipe.img" placeholder="img.jpg...">
            </div>
          </div>
          <div class="card-footer">
            <button type="button" class="btn btn-outline-primary btn-block bg-blue" @click="saveEditedRecipe()">Save Recipe</button>
          </div>
        </div>
      </div>
    </div>
